...
DEFINITIONS = {
    ...
    "find_orders": {"name": "find_orders", "description": "Find fictional orders for one exact customer ID (for example C-1001). Returns a list, possibly empty; an empty list is success. Does not search names, change orders or decide policy.", "input_schema": schema({"customer_id": CUSTOMER_ID})},
