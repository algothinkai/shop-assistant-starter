...
class OrchestrationChecks(unittest.TestCase):
    ...
    def test_unrecognized_or_malformed_charge_lines_cannot_enrich(self):
        for line in ("Handling: USD 1.00", "Tax : USD 3.80", "Mystery surcharge 1.00", "Item: shipping USD 1.00 x1", "Item: shipping $1.00 x1", "Item: shipping usd 1.00 x1", "Item: shipping USD one x1"):
            enrich = Mock(return_value={"id": "O-1003"})
